#!/usr/bin/env python3
"""
generate_seed_data.py — Seed Data Generator for the pension domain

Generates realistic SQL INSERT statements for the legacy pension database schema.
Output is designed to be piped directly to PostgreSQL:
    python3 generate_seed_data.py > seed.sql
    psql -d pension -f seed.sql
...
def emit_sql(ctx):
    ...
    print("-- ================================================================")
    print("-- Seed Data — Generated by generate_seed_data.py")
...
def main():
    print("-- Initializing seed data generator...", file=sys.stderr)
    ctx = SeedDataContext()
