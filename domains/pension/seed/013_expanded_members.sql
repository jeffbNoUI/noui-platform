-- =============================================================================
-- Expanded Demo Members (10004–10010)
...
-- =============================================================================
-- DEMO MEMBER 4: Maria Santos (10004)
...
INSERT INTO MEMBER_MASTER (
    ...
    10004, '555-45-6789', 'Maria', 'Santos', '1965-07-20', 'F',
...
(10004, 'PROMOTION', '2005-01-01', 'DFD', 'ANLY2', 58000.00, 'Promotion to Analyst II'),
...
(10004, '2026-01-09', 329.73, 700.43, 169000.00, 360000.00, 0, 2025),
(10004, '2026-01-23', 329.73, 700.43, 169329.73, 360700.43, 0, 2025),
(10004, '2026-02-06', 329.73, 700.43, 169659.46, 361400.86, 0, 2025),
(10004, '2026-02-20', 329.73, 700.43, 169989.19, 362101.29, 0, 2025),
(10004, '2026-03-06', 329.73, 700.43, 170318.92, 362801.72, 0, 2025);
...
-- =============================================================================
-- DEMO MEMBER 5: James Wilson (10005)
...
(10005, 'PROMOTION', '2014-01-01', 'DHS', 'BADG2', 62000.00, 'Promotion to Budget Analyst II');
...
(10005, '2026-03-06', 5, 78486.00, 3018.69, 3018.69, 0, 2025);

-- Contribution history: EE = 3018.69 * 0.0845 = 255.08, ER = 3018.69 * 0.1795 = 541.85
INSERT INTO CONTRIBUTION_HIST (MEMBER_ID, PAY_PERIOD_END, EE_CONTRIB, ER_CONTRIB, EE_BALANCE, ER_BALANCE, INTEREST_AMT, FY_YEAR) VALUES
(10005, '2026-01-09', 255.08, 541.85, 96000.00, 205000.00, 0, 2025),
(10005, '2026-01-23', 255.08, 541.85, 96255.08, 205541.85, 0, 2025),
(10005, '2026-02-06', 255.08, 541.85, 96510.16, 206083.70, 0, 2025),
(10005, '2026-02-20', 255.08, 541.85, 96765.24, 206625.55, 0, 2025),
(10005, '2026-03-06', 255.08, 541.85, 97020.32, 207167.40, 0, 2025);
...
(10006, '2026-02-20', 4, 66744.00, 2567.08, 2567.08, 0, 2025),
(10006, '2026-03-06', 5, 66744.00, 2567.08, 2567.08, 0, 2025);

-- Contribution history: EE = 2567.08 * 0.0845 = 216.92, ER = 2567.08 * 0.1795 = 460.79
INSERT INTO CONTRIBUTION_HIST (MEMBER_ID, PAY_PERIOD_END, EE_CONTRIB, ER_CONTRIB, EE_BALANCE, ER_BALANCE, INTEREST_AMT, FY_YEAR) VALUES
(10006, '2026-01-09', 216.92, 460.79, 48000.00, 103000.00, 0, 2025),
(10006, '2026-01-23', 216.92, 460.79, 48216.92, 103460.79, 0, 2025),
(10006, '2026-02-06', 216.92, 460.79, 48433.84, 103921.58, 0, 2025),
(10006, '2026-02-20', 216.92, 460.79, 48650.76, 104382.37, 0, 2025),
(10006, '2026-03-06', 216.92, 460.79, 48867.68, 104843.16, 0, 2025);
...
-- =============================================================================
-- DEMO MEMBER 7: Thomas O'Brien (10007)
...
INSERT INTO MEMBER_MASTER (
    ...
    10007, '555-78-9012', 'Thomas', 'O''Brien', '1968-01-15', 'M',
...
(10007, 'PROMOTION', '2008-01-01', 'DPD', 'ENG2', 64000.00, 'Promotion to Engineer II'),
(10007, 'PROMOTION', '2015-01-01', 'DPD', 'ENG3', 82000.00, 'Promotion to Senior Engineer'),
(10007, 'SEPARATION', '2022-06-30', 'DPD', 'ENG3', 96000.00, 'Voluntary separation');
...
(10007, '2022-01-14', 1, 96000.00, 3692.31, 3692.31, 0, 0, 2021),
(10007, '2022-03-25', 6, 96000.00, 3692.31, 3692.31, 0, 0, 2021),
(10007, '2022-06-17', 12, 96000.00, 3692.31, 3692.31, 0, 0, 2021),
(10007, '2022-07-01', 13, 96000.00, 3972.31, 3692.31, 280.00, 0, 2022);

-- Contribution history (frozen since termination — show last known balances)
INSERT INTO CONTRIBUTION_HIST (MEMBER_ID, PAY_PERIOD_END, EE_CONTRIB, ER_CONTRIB, EE_BALANCE, ER_BALANCE, INTEREST_AMT, FY_YEAR) VALUES
(10007, '2022-07-01', 312.00, 662.78, 145000.00, 309000.00, 0, 2022);
...
-- =============================================================================
-- DEMO MEMBER 8: Angela Davis (10008)
...
INSERT INTO CONTRIBUTION_HIST (MEMBER_ID, PAY_PERIOD_END, EE_CONTRIB, ER_CONTRIB, EE_BALANCE, ER_BALANCE, INTEREST_AMT, FY_YEAR) VALUES
(10008, '2026-01-09', 295.92, 628.61, 106000.00, 225000.00, 0, 2025),
(10008, '2026-01-23', 295.92, 628.61, 106295.92, 225628.61, 0, 2025),
(10008, '2026-02-06', 295.92, 628.61, 106591.84, 226257.22, 0, 2025),
(10008, '2026-02-20', 295.92, 628.61, 106887.76, 226885.83, 0, 2025),
(10008, '2026-03-06', 295.92, 628.61, 107183.68, 227514.44, 0, 2025);
...
-- =============================================================================
-- DEMO MEMBER 9: Richard Chen (10009)
...
(10009, '2026-03-06', 5, 76529.00, 2943.42, 2943.42, 0, 2025);

-- Contribution history: EE = 2943.42 * 0.0845 = 248.72, ER = 2943.42 * 0.1795 = 528.34
INSERT INTO CONTRIBUTION_HIST (MEMBER_ID, PAY_PERIOD_END, EE_CONTRIB, ER_CONTRIB, EE_BALANCE, ER_BALANCE, INTEREST_AMT, FY_YEAR) VALUES
(10009, '2026-01-09', 248.72, 528.34, 69000.00, 146000.00, 0, 2025),
(10009, '2026-01-23', 248.72, 528.34, 69248.72, 146528.34, 0, 2025),
(10009, '2026-02-06', 248.72, 528.34, 69497.44, 147056.68, 0, 2025),
(10009, '2026-02-20', 248.72, 528.34, 69746.16, 147585.02, 0, 2025),
(10009, '2026-03-06', 248.72, 528.34, 69994.88, 148113.36, 0, 2025);
...
-- =============================================================================
-- DEMO MEMBER 10: Patricia Moore (10010)
...
INSERT INTO MEMBER_MASTER (
    ...
    10010, '555-01-2345', 'Patricia', 'Moore', '1966-11-30', 'F',
...
(10010, 'PROMOTION', '2009-01-01', 'DCA', 'BADG2', 60000.00, 'Promotion to Budget Analyst II'),
(10010, 'PROMOTION', '2016-01-01', 'DCA', 'BADG3', 76000.00, 'Promotion to Budget Analyst III');
...
INSERT INTO CONTRIBUTION_HIST (MEMBER_ID, PAY_PERIOD_END, EE_CONTRIB, ER_CONTRIB, EE_BALANCE, ER_BALANCE, INTEREST_AMT, FY_YEAR) VALUES
(10010, '2026-01-09', 308.30, 654.92, 156000.00, 332000.00, 0, 2025),
(10010, '2026-01-23', 308.30, 654.92, 156308.30, 332654.92, 0, 2025),
(10010, '2026-02-06', 308.30, 654.92, 156616.60, 333309.84, 0, 2025),
(10010, '2026-02-20', 308.30, 654.92, 156924.90, 333964.76, 0, 2025),
(10010, '2026-03-06', 308.30, 654.92, 157233.20, 334619.68, 0, 2025);
