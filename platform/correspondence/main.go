...
func main() {
	...
	mux.HandleFunc("GET /health/detail", healthutil.NewDetailHandler("correspondence", "0.1.0", startedAt, database, counters))
	mux.HandleFunc("GET /ready", healthutil.NewReadyHandler("correspondence", database))
