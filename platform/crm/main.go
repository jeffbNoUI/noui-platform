...
func main() {
	...
	mux.HandleFunc("GET /health/detail", healthutil.NewDetailHandler("crm", "0.1.0", startedAt, database, counters))
	mux.HandleFunc("GET /ready", healthutil.NewReadyHandler("crm", database))
