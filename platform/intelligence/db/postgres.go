// Package db provides PostgreSQL database connectivity and data access for the intelligence service.
package db
...
// Store wraps a database connection and exposes intelligence data-access methods.
type Store struct {
	DB *sql.DB
}
...
func ConfigFromEnv() Config {
	return Config{
		...
		MaxOpenConns: envutil.GetEnvInt("DB_MAX_OPEN_CONNS", 3),
		MaxIdleConns: envutil.GetEnvInt("DB_MAX_IDLE_CONNS", 1),
	}
}
